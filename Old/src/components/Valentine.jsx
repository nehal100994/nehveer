...
const noMessages = [
    ...
    "Viren… that button is starting to look suspicious 😏",
            ...
            <div className="fixed top-4 right-4 z-20 flex gap-2">
                {Object.keys(themes).map(t => (
                    <button
                        key={t}
                        onClick={() => setTheme(t)}
                        className={`w-8 h-8 rounded-full border-2 ${theme === t ? "border-white scale-110" : "border-white/40"
                            } transition`}
                ...
                <main className="relative z-10 w-[92vw] max-w-xl rounded-3xl p-8 text-center shadow-2xl bg-white/80 backdrop-blur-xl">
                    ...
                    {step === "intro" && (
                        <div className="animate-pop">
                            <h1 className="text-4xl font-extrabold mb-6">Hey Viren 💕</h1>
